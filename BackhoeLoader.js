...
class BackhoeLoader extends Component {
  ...
  questions = [
	...
	{
      page: 'Drivetrain',
      comment: 'The operational test is constrained to slow, load-free trials within a confined flat space, limiting the full verification of differential interlocks, complete transmission shifting, and drive axle functionality. The inspector primarily focuses on detecting unusual sounds, spotting leaks, and documenting physical damage.',
      questions: [
        'Transmission', 
