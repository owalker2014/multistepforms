...
class CrawlerDozer extends Component {
  ...
  questions = [
	...
	{
      page: 'Drivetrain',
      comment: 'The operational test is limited to low-speed, load-free conditions in a confined, flat area. Full verification of differential interlocks, transmission shifting, and drive axle functionality isnt possible. The inspector checks for abnormal noises, leaks, and physical damage.',
      questions: [
        'Drive Motors', 
        'Final Drives', 
